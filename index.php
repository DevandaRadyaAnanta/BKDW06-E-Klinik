...
<body>
    <nav class="navbar navbar-expand-lg navbar-primary bg-info">
        <div class="container-fluid">
            <a href="index.php"><img src="logo.png" width="30px" alt=""></a>
            <a class="navbar-brand mx-1" href="index.php">E-Klinik</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="index.php?page=pasiendaftar">Daftar Poli</a>
                    </li>
                    <?php
    ...
    <div class="row mt-5">
        <div class="col-md-12">
            <div class="alert alert-info" role="alert">
                <center>
                    &copy; 2024 E-Klinik. All rights reserved.
                </center>
            </div>
        </div>
    </div>
